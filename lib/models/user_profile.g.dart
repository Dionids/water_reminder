...
const UserProfileSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'dailyBaseGoal': PropertySchema(
      id: 1,
      name: r'dailyBaseGoal',
      type: IsarType.long,
    ),
...
void _userProfileSerialize(
  ...
  writer.writeLong(offsets[1], object.dailyBaseGoal);
...
extension UserProfileQuerySortBy
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortByDailyBaseGoal() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dailyBaseGoal', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy>
      sortByDailyBaseGoalDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dailyBaseGoal', Sort.desc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortByLastSync() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastSync', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortByLastSyncDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileQuerySortThenBy
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenByDailyBaseGoal() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dailyBaseGoal', Sort.asc);
    });
  }
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenByLastSync() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastSync', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenByLastSyncDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastSync', Sort.desc);
    });
  }
...
extension UserProfileQueryWhereDistinct
  ...
  QueryBuilder<UserProfile, UserProfile, QDistinct> distinctByDailyBaseGoal() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'dailyBaseGoal');
    });
  }

  QueryBuilder<UserProfile, UserProfile, QDistinct> distinctByLastSync() {
    return QueryBuilder.apply(this, (query) {
